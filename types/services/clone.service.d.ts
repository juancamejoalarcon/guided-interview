...
export declare class Cloner {
    ...
    questionExistsInInterview(id: string): GenericQuestion | undefined;
    getQuestionInInterview(id: string): GenericQuestion | undefined;
    getQuestionInsideRepeat(id: string): GenericQuestion | undefined;
